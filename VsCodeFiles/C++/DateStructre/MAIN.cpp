...
int main(void)
{
    Tree mytree;
    mytree.CreateTree();
    mytree.TravelTree(mytree.GetBasenode());
    cout << "The nummber of this tree is:" << endl;
    mytree.Getnumber();
    cout << "The left childtree's height is:" << endl;
    mytree.Getheightleft(mytree.GetBasenode());
    cout << "The right childtree's height is:" << endl;
    mytree.Getheightright(mytree.GetBasenode());
     cout << "The tree's height is:" << endl;
    mytree.Getheight(mytree.GetBasenode());
    return 0;
}
